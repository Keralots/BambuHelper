...
// Layout profile: ST7701 2.8" round 480x480 (DISPLAY_ROUND_480).
// PLACEHOLDER - still a verbatim copy of the 240 profile so the dispatcher
// compiles. Scaled to 480 in a following commit.
