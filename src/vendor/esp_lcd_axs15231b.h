...
// hal/spi_ll.h removed — not used in this header, and including it from C++
// breaks due to duplicate operator<<= definitions across multiple FLAG_ATTR
// typedefs in arduino-esp32 3.0.x.
// esp_lcd_touch.h removed — touch API is out of scope for our display-only fork.
#include "esp_lcd_panel_vendor.h"

// Arduino-esp32 3.0.x ships ESP-IDF 5.1 which uses esp_lcd_color_space_t
// (ESP_LCD_COLOR_SPACE_RGB/BGR). The vendor driver source was written
// against ESP-IDF 5.2+ which renamed these to LCD_RGB_ELEMENT_ORDER_RGB/BGR.
 ...
 *      - ESP_OK: on success
 */
// esp_lcd_touch_new_i2c_axs15231b declaration removed — display-only fork.
