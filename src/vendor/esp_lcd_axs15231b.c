...
// Touch forward declarations and implementation removed — this build is
// display-only. Touch is driven by a separate I2C path in main_vendor.cpp.
...
esp_err_t esp_lcd_new_panel_axs15231b(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel)
{
    ...
    axs15231b->base.disp_off     = panel_axs15231b_disp_off;  // arduino-esp32 3.0.x/ESP-IDF 5.1 struct field name
